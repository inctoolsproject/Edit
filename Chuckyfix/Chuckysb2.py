...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EpuD9LuSF9g4YzDRSSEa.l6Ha5iuE5BX8ACSSNwEkQG.ZaiKUWv/EAFKP/46WYtJo+8hAs9no5ytTOAN/ZKzBEY=')
nadya.loginResult()
...
╚═════════════════════════
"""
tjia="u2fa840e4851ee5bc7c69cb2c9d678aaa"
...
Bots=[mid]
Creator=["u2fa840e4851ee5bc7c69cb2c9d678aaa"]
admin=["u2fa840e4851ee5bc7c69cb2c9d678aaa","u457f7e53b5569786ebd6cbb3849872f2","u16f7d26b48477d74868ed05ab48b52b4","uc249e2382574dd38538626c72f6088ff"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By Novuz",    
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            nadya.sendText(op.param1,"Itu Kenapa Yang Out Baper Ya  ͡° ͜ʖ ͡° " + nadya.getContact(op.param2).displayName +  "\nNtar kalo udah sembuh balik lagi ya kakak ๑◔‿◔๑ . . . (p′︵‵。) 🤗")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "13269542",
                                    "STKPKGID": "1329191",
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to, "Khusus KangMazG")
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus KangMazG")
                ...
                wait["Sider"] = True
                nadya.sendText(msg.to,"Siap On Cek Cctv")
